...
function ClinicalApplications({ city }: { city?: string }) {
    ...
    return (
        <div className="w-full bg-slate-50 py-24 lg:py-32">
            <m.div className="container mx-auto px-4 mb-16 text-center" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
            ...
            <m.div className="container mx-auto px-2 text-center" initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
                <CallButton
