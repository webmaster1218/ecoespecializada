  ...
  const saveBooking = async () => {
    try {
      ...
      if (formData.quantities.z6 > 0) {
        summaryParts.push(
          `ECOGRAFO Z6${formData.includeCart ? " CON CARRITO" : ""}`,
        );
      }
      ...
      if (formData.selectedTransducers?.length > 0) {
        summaryParts.push(
          `TRANSDUCTORES: ${formData.selectedTransducers.join(", ")}`,
        );
      }
      ...
      try {
        ...
        if (!emailResponse.ok) {
          ...
          try {
            ...
            alert(
              `⚠️ Error SMTP: ${errorDetails.error || "Error desconocido"}`,
            );
          } catch (e) {
            alert(
              `⚠️ Error del Servidor (500): ${errorText.substring(0, 100)}`,
            );
          }
        }
      } catch (emailErr: any) {
  ...
  const validateStep = (currentStep: number): boolean => {
    ...
    if (currentStep === 1) {
      ...
      if (!formData.deliveryTime)
        newErrors.deliveryTime = "Horario de entrega requerido";
        ...
        >
          ...
          <div className="border-b border-slate-100 p-6 bg-white">
            <div className="flex justify-between items-center max-w-2xl mx-auto relative">
              ...
              <div
                className={`absolute top-1/2 left-0 h-1 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-full -z-0 transition-all duration-500`}
              ...
              {[1, 2, 3].map((num) => (
                <div
                  key={num}
                  className={`relative z-10 w-12 h-12 rounded-full flex items-center justify-center font-bold transition-all duration-300 border-4 border-white ${
                    step >= num
              ...
              <div className="mb-6 bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-100 rounded-2xl p-4 flex items-center gap-4 shadow-sm relative overflow-hidden">
                ...
                <div className="z-10">
                  ...
                  <p className="text-emerald-700 text-xs font-medium mt-0.5">
                    Automáticamente aplicado al finalizar tu solicitud.
                  </p>
                </div>
              </div>
            )}
                  ...
                  <div className="grid md:grid-cols-2 gap-5">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          updateData("documentNumber", e.target.value)
                        }
                      />
              ...
              {step === 1 && (
                ...
                >
                  <div className="text-center md:text-left">
                    ...
                    <p className="text-slate-500 text-sm mt-1">Selecciona las fechas y horarios de tu alquiler.</p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-slate-50/50 p-5 rounded-[24px] border border-slate-100">
                      ...
                      <div className="space-y-1.5">
                        ...
                        <div className="relative group">
                          ...
                          <select
                            ...
                            onChange={(e) =>
                              updateData("deliveryTime", e.target.value)
                            }
                          >
                      ...
                      <div className="space-y-1.5">
                        ...
                        <div className="relative group">
                          ...
                          <select
                            ...
                            onChange={(e) =>
                              updateData("collectionTime", e.target.value)
                            }
                          >
                            <option value="">Selecciona horario</option>
                    ...
                    {totalDays > 0 && (
                      <div className="md:col-span-2 flex justify-between items-center bg-blue-600/5 text-blue-700 px-4 py-2.5 rounded-2xl text-sm font-bold border border-blue-100/50">
                        ...
                        <span className="bg-blue-600 text-white px-3 py-0.5 rounded-full text-xs shadow-sm">
                  ...
                  <div className="pt-2">
                    <h4 className="font-bold text-slate-800 mb-3 flex items-center justify-between">
                      ...
                      {isCheckingAvailability ? (
                        <span className="text-[10px] uppercase bg-yellow-100 text-yellow-700 px-2 py-1 rounded-full font-bold animate-pulse">
                          Verificando...
                        </span>
                      ) : (
                        formData.startDate &&
                        formData.endDate && (
                          <span className="text-[10px] uppercase bg-emerald-100 text-emerald-700 px-2 py-1 rounded-full font-bold">
                            Stock verificado
                          </span>
                        )
                      )}
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      {[
                        ...
                        >
                          {item.badge && (
                            <span className="absolute -top-2 right-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-[9px] font-extrabold px-3 py-1 rounded-full shadow-lg uppercase tracking-wider">
                              {item.badge}
                            </span>
                          )}
                          ...
                          {availabilitySuggestions[item.id as "z6" | "z60" | "m7"] && (
                            <div className="mt-3 text-[10px] text-amber-600 font-bold bg-amber-50 p-2 rounded-xl border border-amber-100 flex items-start gap-2 animate-in fade-in slide-in-from-top-1">
                              ...
                              />
                              <span>
                                Sin stock. Próxima fecha disponible:{" "}
                  ...
                  <div className="pt-2">
                    <h4 className="font-bold text-slate-800 mb-3 flex items-center justify-between">
                      ...
                      <span className="text-[10px] uppercase bg-blue-100 text-blue-700 px-2 py-1 rounded-full font-bold">
                        ...
                        >
                          <div className="flex flex-col">
                            <div className="flex items-center justify-between mb-1">
                              ...
                              <div
                                className={`w-5 h-5 rounded-lg border-2 flex items-center justify-center transition-all ${(formData.selectedTransducers || []).includes(t.id) ? "border-blue-500 bg-blue-500 shadow-sm" : "border-slate-200 bg-white"}`}
                              >
                            ...
                            <span className="text-[10px] leading-tight opacity-70 font-medium">
                              {t.desc}
                            </span>
                          </div>
                        </button>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    {/* Cart Option */}
                    <div
                      className={`p-3 rounded-2xl border transition-colors ${formData.includeCart ? "bg-indigo-50 border-indigo-200" : "bg-slate-50 border-slate-100"}`}
                    >
                      <div className="flex items-center gap-3">
                        <div className="relative w-10 h-10 rounded-lg overflow-hidden bg-white border border-slate-200 flex-shrink-0">
                          <Image
                            src="/images/cart_thumbnail.webp"
                            alt="Carrito"
                            fill
                            ...
                            <div className="text-right">
                              ...
                              <label className="relative inline-flex items-center cursor-pointer mt-0.5">
                                <input
                                  ...
                                  onChange={(e) =>
                                    updateData("includeCart", e.target.checked)
                                  }
                    ...
                    {/* Printer Option */}
                    <div
                      className={`p-3 rounded-2xl border transition-colors ${formData.includePrinter ? "bg-indigo-50 border-indigo-200" : "bg-slate-50 border-slate-100"}`}
                    >
                      <div className="flex items-center gap-3">
                        <div className="relative w-10 h-10 rounded-lg overflow-hidden bg-white border border-slate-200 flex-shrink-0">
                          <Image
                            src="/images/printer_sony.webp"
                            alt="Impresora Sony"
                            fill
                            className="object-cover"
                          />
                  ...
                  <div className="bg-slate-900 text-white p-4 rounded-[20px] flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 shadow-lg relative overflow-hidden">
                    ...
                    <div className="text-right flex flex-col items-end relative z-10">
                      <div className="text-xs text-slate-500 mb-1">
                        {formData.quantities.z6 + formData.quantities.z60}{" "}
                        Equipos
                      </div>
                      {totalDays > 0 && (
                    ...
                    <div className="bg-blue-50 border border-blue-100 rounded-2xl p-4 flex items-start gap-4 shadow-sm">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-blue-700/80 leading-relaxed font-medium">
                          Respetamos estrictamente los horarios de entrega y
                          recogida seleccionados para garantizar el mejor
                          servicio.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="bg-blue-50/50 p-4 md:p-6 rounded-[20px] border border-blue-100 relative overflow-hidden">
                    ...
                    <ul className="space-y-2 relative z-10">
                      ...
                      {formData.quantities.z6 > 0 && (
                        <li className="flex justify-between items-center text-sm">
                          <span className="text-slate-600">
                            {formData.quantities.z6}x Mindray Z6
                          </span>
                          <span className="font-semibold text-slate-800">
                            $
                            {(
                      ...
                      {formData.quantities.z60 > 0 && (
                        <li className="flex justify-between items-center text-sm">
                          <span className="text-slate-600">
                            {formData.quantities.z60}x Mindray Z60
                          </span>
                          <span className="font-semibold text-slate-800">
                            $
                            {(
                        ...
                        <li className="flex flex-col gap-1 py-1">
                          ...
                          <div className="flex flex-wrap gap-1.5">
                            {formData.selectedTransducers.map((t) => (
                              <span
                                key={t}
                                className="px-2 py-0.5 bg-blue-100 text-blue-700 rounded-md text-[10px] font-bold"
                              >
                                {t}
                              </span>
                            ))}
              ...
              {step === 4 && (
                ...
                >
                  ...
                  <p className="text-slate-600 max-w-md mx-auto mb-10 text-lg leading-relaxed">
                    Hemos recibido tu solicitud de reserva. Un asesor comercial
                    se pondrá en contacto contigo al{" "}
          ...
          {step < 4 && (
            <div className="p-4 md:p-6 border-t border-slate-100 flex justify-between bg-slate-50 items-center">
              ...
              >
                {isSubmitting
                  ? "Procesando, no te salgas de la pagina..."
                  : step === 3
                    ? "Confirmar reserva"
                    : "Continuar"}{" "}
