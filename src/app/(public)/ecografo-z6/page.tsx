        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            >
              ...
              <Image
                src="/images/z6/z6-abierto-derecha.webp"
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="text-center max-w-3xl mx-auto mb-12 md:mb-20 animate-on-scroll">
            <span className="text-blue-600 font-bold uppercase tracking-widest text-xs md:text-sm mb-4 block">
              Equilibrio de Alto Nivel
            </span>
            <h2 className="text-3xl md:text-[3rem] font-extrabold text-slate-900 mb-6 tracking-tight">Equilibrio entre <span className="text-gradient">Potencia y Movilidad</span></h2>
            <p className="text-base md:text-lg text-slate-600">El Mindray Z6 está diseñado para ser tu aliado en diagnósticos rápidos y precisos sin importar la ubicación.</p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div className="space-y-8 md:space-y-10">
              <div>
                ...
                <h2 className="text-3xl md:text-[3rem] font-extrabold text-slate-900 mb-6 tracking-tight">Tecnología de <span className="text-gradient">Imagen Avanzada</span></h2>
                <p className="text-lg md:text-xl text-slate-600 leading-relaxed font-medium">El Z6 hereda el legado de Mindray en calidad de imagen, ofreciendo herramientas de gama alta en un formato portátil.</p>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 text-base leading-relaxed">Reduce el ruido de la imagen y mejora la resolución de contraste para una visualización más clara de los tejidos.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-5">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-slate-900 mb-1">Imágenes Armónicas PSH™</h3>
                    <p className="text-slate-600 text-base leading-relaxed">Obtén una mejor resolución de contraste proporcionando una calidad de imagen más nítida con excelente resolución.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-5">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-slate-900 mb-1">iStation™</h3>
                    <p className="text-slate-600 text-base leading-relaxed">Sistema de gestión de información de pacientes único de Mindray que permite integrar, revisar y archivar datos de forma eficiente.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          >
            <div className="relative z-10">
              ...
              <p className="text-base md:text-xl text-blue-50 mb-8 md:mb-10 max-w-2xl mx-auto font-medium opacity-90">
                Nuestros especialistas están listos para resolver todas tus dudas
              </p>
